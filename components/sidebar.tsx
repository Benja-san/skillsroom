...
export default function Sidebar({activeMenu, setActiveMenu} : any) {
    ...
    return <nav className={`${styles.navigation} ${activeMenu ? styles.displayed : ""}`}>
        <div className={`${styles.menu}`}>
            <button onClick={toggleMenu} className={`${styles.burger} ${styles.active}`} type="button">
            ...
            <li className={styles.linkContainer}>
                <Link href="/home">
                    <div className={styles.link}>
                        ...
                        <span>Ho<span className={styles.letterToColor}>m</span>e</span>
                    </div>
                </Link>
            </li>
            <li className={styles.linkContainer}>
                <Link href="/about">
                    <div className={styles.link}>
                        ...
                        <span>About <span className={styles.letterToColor}>U</span>s</span>
                    </div>
                </Link>
            </li>
            <li className={styles.linkContainer}>
